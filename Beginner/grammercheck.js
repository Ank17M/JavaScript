//A Program to check Grammer error in the given text messages
...
//Counting each word in the story
let count = 0;
...
const findLongWordIndex = storyWords.findIndex(word => {
  return word === 'breathtaking';
});
console.log(findLongWordIndex);
